...
(setq-default
 ...
 dotspacemacs-default-layout-name "kuro"
 ;; "\ue231 andrea"
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (jabber srv fsm insert-shebang fish-mode
            company-shell proof-general moonscript
            lua-mode systemd sql-indent x86-lookup
            terraform-mode hcl-mode nasm-mode mode-icons
            jinja2-mode emoji-cheat-sheet-plus dockerfile-mode
            docker docker-tramp disaster company-emoji
            company-c-headers company-ansible cmake-mode
            clang-format auctex-latexmk ansible-doc ansible
            all-the-icons-ivy ivy all-the-icons-dired
            flycheck-golangci-lint tide typescript-mode
            prettier-js csv-mode toml-mode racer flycheck-rust
            cargo rust-mode lv spaceline-all-the-icons
            highlight-indent-guides transient turing-theme
            yasnippet-snippets company-quickhelp yapfify
            yaml-mode xterm-color web-mode web-beautify
            vmd-mode unfill tagedit smeargle slim-mode
            shell-pop scss-mode sass-mode rvm ruby-tools
            ruby-test-mode rubocop rspec-mode robe rbenv
            rainbow-mode rainbow-identifiers pyvenv pytest
            pyenv-mode py-isort puppet-mode pug-mode
            projectile-rails rake inflections pip-requirements
            pdf-tools tablist origami orgit nginx-mode mwim
            multi-term mmm-mode minitest markdown-toc
            markdown-mode magit-gitflow livid-mode skewer-mode
            simple-httpd live-py-mode json-mode json-snatcher
            json-reformat js2-refactor multiple-cursors
            js2-mode js-doc intero hy-mode hlint-refactor
            hindent helm-pydoc helm-hoogle helm-gitignore
            helm-css-scss helm-company helm-c-yasnippet
            haskell-snippets haml-mode go-playground gotest
            go-guru go-eldoc gitignore-mode gitconfig-mode
            gitattributes-mode git-timemachine git-messenger
            git-link git-gutter-fringe+ git-gutter-fringe
            fringe-helper git-gutter+ git-gutter gh-md fuzzy
            flyspell-popup flyspell-correct-helm flyspell-correct
            flycheck-pos-tip pos-tip flycheck-haskell
            flycheck-gometalinter flycheck feature-mode
            evil-magit magit magit-popup git-commit ghub treepy
            graphql with-editor eshell-z eshell-prompt-extras
            esh-help emmet-mode diff-hl cython-mode company-web
            web-completion-data company-tern dash-functional
            tern company-statistics company-go go-mode
            company-ghci company-ghc ghc haskell-mode
            company-cabal company-auctex company-anaconda
            company color-identifiers-mode coffee-mode cmm-mode
            chruby bundler inf-ruby beacon auto-yasnippet
            yasnippet auto-dictionary auctex anaconda-mode
            pythonic all-the-icons memoize ac-ispell
            ...
            evil-exchange evil-escape evil-ediff evil-args evil-anzu
            anzu evil goto-chg undo-tree eval-sexp-fu highlight elisp-slime-nav
            dumb-jump f dash s diminish define-word column-enforce-mode
            clean-aindent-mode bind-map bind-key auto-highlight-symbol
            auto-compile packed aggressive-indent adaptive-wrap ace-window
            ace-link ace-jump-helm-line helm avy helm-core popup async))))
(custom-set-faces
